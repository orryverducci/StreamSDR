...
using StreamSDR.Radios.SdrPlay.Parameters.Device;
...
internal struct DevParams
{
    ...
    /// </summary>
    public Rsp1a.Params Rsp1aParams;

    /// <summary>
    /// The parameters for a RSP2 device.
    /// </summary>
    public Rsp2.Params Rsp2Params;

    /// <summary>
    /// The parameters for a RSPduo device.
    /// </summary>
    public RspDuo.Params RspDuoParams;

    /// <summary>
    /// The parameters for a RSPdx device.
    /// </summary>
    public RspDx.Params RspDxParams;
}
